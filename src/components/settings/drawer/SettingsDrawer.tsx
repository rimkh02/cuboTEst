      ...
      >
        ...
        >
          <Typography variant="subtitle1" sx={{ flexGrow: 1 }}>
            {translate('setting_mode.Settings')}
          </Typography>

          <Tooltip title={translate('setting_mode.reset')}>
        ...
        <Scrollbar sx={{ p: SPACING, pb: 0 }}>
          <Block title={translate('setting_mode.Mode')}>
            <ModeOptions />
          </Block>

          <Block title={translate('setting_mode.Contrast')}>
            <ContrastOptions />
          </Block>

          <Block title={translate('setting_mode.Direction')}>
            <DirectionOptions />
          </Block>

          <Block title={translate('setting_mode.Layout')}>
            <LayoutOptions />
          </Block>

          <Block
            title={translate('setting_mode.Stretch')}
